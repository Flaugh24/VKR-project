...
<c:choose>
    <c:when test="${!(ticketAttribute.status.id == 3 || ticketAttribute.status.id == 4 || ticketAttribute.status.id == 7)}">
    ...
    <div class="main">
        <div class="row">
            <div class="col-md-5" style="max-height: 100vh; overflow-y: auto; padding-bottom: 100px">
                ...
                <c:if test="${ticketAttribute.status.id == 3 || ticketAttribute.status.id == 4 || ticketAttribute.status.id == 7}">
