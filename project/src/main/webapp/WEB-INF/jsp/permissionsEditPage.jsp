...
<body>
<c:url value="/admin/permissions/${dto.pathVariable}" var="saveUrl"/>
<header>
        ...
        <form:form commandName="dto" action="${saveUrl}" method="post">
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th style="vertical-align: middle; text-align: center">Права</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${permissionsAll}" var="permission">
                    <tr>
                        <td style="vertical-align: middle; text-align: center"><form:checkbox path="checkedValsInt"
