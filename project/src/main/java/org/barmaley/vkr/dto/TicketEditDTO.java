...
public class TicketEditDTO {
    ...
    public String getDocumentTypeNameEng() {
        return documentTypeNameEng;
    }

    public void setDocumentTypeNameEng(String documentTypeNameEng) {
